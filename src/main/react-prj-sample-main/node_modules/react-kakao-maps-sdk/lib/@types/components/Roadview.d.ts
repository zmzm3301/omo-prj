...
declare type RoadviewComponent = <T extends React.ElementType = "div">(props: PolymorphicComponentPropsWithOutRef<T, RoadviewProps> & React.RefAttributes<kakao.maps.Roadview>) => React.ReactElement | null;
/**
